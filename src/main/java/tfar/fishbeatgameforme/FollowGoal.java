...
public class FollowGoal extends Goal{
    private static final TargetingConditions TEMP_TARGETING = (new TargetingConditions()).range(20.0D).allowInvulnerable().allowSameTeam().allowNonAttackable().allowUnseeable();
    ...
    public FollowGoal(PathfinderMob pathfinderMob, double d, boolean bl) {
